...
exports.imageUpload = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(imageFile, "gallery");
...
exports.videoUpload = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(videoFile, "gallery");
...
exports.imageReducer = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(imageFile, "gallery", 50);
        console.log(response)
