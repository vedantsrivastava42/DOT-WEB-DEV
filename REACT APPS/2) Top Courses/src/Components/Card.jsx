...
//insert karna h ye course liked courses me 
  if(likedCourses.length === 0){
    ...
    //purani jitni id thi wo aur jo abhi like hui hai uski id bhi dalenge
  ...
  return (
    <div className='w-[300px] bg-bgDark bg-opacity-80 rounded-md overflow-hidden'>
       <div className='relative'>
               ...
               <div className='w-[40px] h-[40px] rounded-full bg-white grid  place-items-center absolute right-2 bottom-[-13px] shadow-xl '>
